...
Consumer = Literal["classify", "ner", "embed", "auto_tag", "smart_route", "compliance_scan", "lang_detect", "translate", "ocr_quality", "anomaly_detect", "training_collector", "model_retrain", "model_evaluate"]
