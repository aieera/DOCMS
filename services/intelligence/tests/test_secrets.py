...
(base64(nonce || ciphertext+tag) under VAULTDMS_LOCAL_KEK)."""
...
def _set_kek(monkeypatch, key_bytes: bytes) -> None:
    monkeypatch.setenv("VAULTDMS_LOCAL_KEK", base64.b64encode(key_bytes).decode())
