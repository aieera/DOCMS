...
// Canonical shadcn Drawer (vaul). Use for mobile sheet-from-
// bottom UIs — feels native on touch, drag handle for dismissal.
// On desktop it works as a centered modal but Sheet is usually
...
>(({ className, children, ...props }, ref) => (
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ref={ref}
      className={cn(
        'fixed inset-x-0 bottom-0 z-50 mt-24 flex h-auto flex-col rounded-t-[10px] bg-background shadow-float',
        className,
      )}
      {...props}
    >
