...
// Canonical shadcn DropdownMenu — full Radix surface (Sub menus,
// CheckboxItem, RadioGroup, Shortcut). Migrate from the bespoke
// ./DropdownMenu by switching imports + replacing the
// `<DropdownMenuItem icon={...}>` shorthand with explicit children
// (icon as the first child, label after).
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      'z-50 min-w-[8rem] overflow-hidden rounded-2xl bg-popover p-1 text-popover-foreground shadow-float',
