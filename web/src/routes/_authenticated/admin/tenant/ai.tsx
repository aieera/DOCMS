      ...
      <div className="mt-6 space-y-5">
        ...
        <Section title="Provider" icon={<KeyRound className="h-4 w-4" />}>
          {showExportControlWarning && (
            <div
              className="mb-3 flex items-start gap-2 rounded-md border border-amber-300 bg-amber-50 p-3 text-xs text-amber-900 dark:border-amber-700 dark:bg-amber-950 dark:text-amber-200"
        ...
        <Section title="Limits" icon={<ShieldAlert className="h-4 w-4" />}>
          ...
          <label className="mt-3 flex cursor-pointer items-center justify-between rounded-md border border-[var(--color-border)] px-3 py-2">
            <div>
        ...
        <Section title="Test the configuration" icon={<Beaker className="h-4 w-4" />}>
          ...
          {testResult && (
            <pre
              className="mt-3 max-h-40 overflow-auto whitespace-pre-wrap rounded-md border border-[var(--color-border)] bg-[var(--color-bg-tertiary)] p-3 text-xs"
